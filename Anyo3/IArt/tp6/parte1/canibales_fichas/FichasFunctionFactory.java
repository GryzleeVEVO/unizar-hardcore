...
public class FichasFunctionFactory {
	...
	private static class FichasActionsFunction implements ActionsFunction {
		...
		public Set<Action> actions(Object state) {
			...
			if (board.canMove(FichasBoard.MB1I))
				actions.add(FichasBoard.MB1I);
			if (board.canMove(FichasBoard.MB2I))
				actions.add(FichasBoard.MB2I);
			if (board.canMove(FichasBoard.MB3I))
				actions.add(FichasBoard.MB3I);
			if (board.canMove(FichasBoard.MB1D))
				actions.add(FichasBoard.MB1D);
			if (board.canMove(FichasBoard.MB2D))
				actions.add(FichasBoard.MB2D);
			if (board.canMove(FichasBoard.MB3D))
				actions.add(FichasBoard.MB3D);
			if (board.canMove(FichasBoard.MV1I))
				actions.add(FichasBoard.MV1I);
			if (board.canMove(FichasBoard.MV2I))
				actions.add(FichasBoard.MV2I);
			if (board.canMove(FichasBoard.MV3I))
				actions.add(FichasBoard.MV3I);
			if (board.canMove(FichasBoard.MV1D))
				actions.add(FichasBoard.MV1D);
			if (board.canMove(FichasBoard.MV2D))
				actions.add(FichasBoard.MV2D);
			if (board.canMove(FichasBoard.MV3D))
				actions.add(FichasBoard.MV3D);
