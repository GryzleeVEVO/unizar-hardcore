/*
	...
	Fichero: cmd/server-secuencial/main.go

	Autores:
		Dorian Boleslaw Wozniak (817570@unizar.es)
		Cristian Andrei Selivanov Dobrisan (816456@unizar.es)

	Descripción: Versión del servidor de la práctica 1 que trata las conexiones
					de forma secuencial a medida que las va recibiendo
*/
