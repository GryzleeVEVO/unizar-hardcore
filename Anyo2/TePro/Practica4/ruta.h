                ...
                if (i != nullptr)
                {
                    ...
                    else
                    {
                        ...
                        if (i->type() == DIR)
                            ...
                            throw name_is_not_directory();
                    }
                }
                // No lo encuentra
                else
                    throw name_does_not_exist();
            }
...
public:
    ...
    void mkdir(const string &name)
    {
        ...
        if (_activedir.top()->find(name) != nullptr)
            throw name_exists();
    ...
    void ln(const string &path, const string &name)
    {
        ...
        if (node_to_link == nullptr)
            node_to_link = temp.top();
    ...
    int stat(const string &path)
    {
        ...
        if (node_to_stat == nullptr)
            node_to_stat = temp.top();
