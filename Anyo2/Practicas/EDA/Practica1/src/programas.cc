/*
    ...
    Descripción: Archivo de implementación de un tipo programa que almacena el nombre, lenguaje,
    fecha de creación y descripción de un programa
*/

#include "programas.h"

// IMPLEMENTACIÓN DEL MÓDULO programas
...
/*
    Pre: true
    Post: Devuelve verdad si y solo si los programas p1 y p2 son iguales, es decir,
            si sus nombres, fechas de creación, lenguajes y descripción son iguales
*/
