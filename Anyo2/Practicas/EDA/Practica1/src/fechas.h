/*
    ...
    Descripción: Archivo de especificación de un tipo fecha, que almacena una fecha
    válida del calendario gregoriano junto a operaciones de acceso y comparación de
    utilidad, según la especificación a continuación
*/
...
/*
    ...
    Parcial: 1 ≤ d ≤ 31, 1 ≤ m ≤ 12, 1583 ≤ a, y además deben formar una fecha válida
...
/*
    ...
    Dadas dos fechas f1 y f2, se obtienen un booleano con valor verdad si y solo si la
...
/*
    ...
    Dadas dos fechas d1 y f2, se obtiene un booleano con valor verdad si y solo si la
