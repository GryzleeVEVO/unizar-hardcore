...
# Date:   octubre 2021
# Coms:   script de comprobación de entrega de la práctica 4 de PSCD (21/22)
#         Funcionamiento: 
...
FICHEROS=(ControlCabinas.hpp ControlCabinas.cpp practica_4.cpp Makefile_p4 disegno.pdf)
...
MAIN_1="practica_4.cpp"
MAIN_2="practica_4_opc_2.cpp" #sin uso curso 21/22
...
then
	echo "${FORM}Can't find neither '${MAIN_1}'"
	FALTAN=(${MAIN_1} "${FALTAN}[@]")
fi
