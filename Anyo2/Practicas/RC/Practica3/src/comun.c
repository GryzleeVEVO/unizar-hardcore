/*
    ...
    Descripción: Fichero de implementación "comun" que dispone de las instrucciones necesarias para
    obtener la información de red para un cliente o servidor

    Se han realizado las siguientes modificaciones:

    - Se ha sustituido el campo hints.ai_socktype de SOCK_STREAM a SOCK_DGRAM para especificar que 
