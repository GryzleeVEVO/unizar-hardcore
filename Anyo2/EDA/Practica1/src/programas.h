/*
    ...
    Descripción: Archivo de especificación de un tipo programa, que almacena el nombre, lenguaje,
    fecha de creación y descripción de un programa, con las operaciones de acceso y comparación
...
/*
    Género programas: Los valores del TAD programas representan la información de
                        que disponemos sobre un programa informático
*/
...
/*
    ...
    Crea un programa de nombre nom, con fecha de creación cre, codificado en lenguaje
    leng, y con descripción desc
*/
...
struct Programa{
    ...
    friend Fecha suFecha(Programa p);
